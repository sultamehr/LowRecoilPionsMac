...
class FSCategory
 {
	...
	//else if (interaction==3){return false;}
		...
		else if (fForbidden.count(9999) == 1 && fRequired.count(211) == 1 && npi >=1 && nother >= 1 ) return true;
...
const std::vector<FSCategory*> pionFSCategories = {   new FSCategory("QElike", {-211, -321, -311, -111,211, 111, 321, 311}),
						      ...
						      new FSCategory("N Pi Plus Only", {-211,111, 321, 311, -111,-321,-311}, {211}, {2}),
                                                      new FSCategory("Neutral Pi Only", {321, -321, 311, -311 ,-211,211}, {111}),
						      ...
						      //new FSCategory("Pi Plus and Neutron", {111,321,311, -311, -321, -111,-311,-211},{211,2112}),
