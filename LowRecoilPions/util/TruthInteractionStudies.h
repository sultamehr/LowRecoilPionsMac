...
class FSCategory
 {
	...
	//else if (interaction==3){return false;}
		...
		else if (fForbidden.count(9999) == 1 && nrequired > 2 && fRequired.count(211) ==1) return true;
...
const std::vector<FSCategory*> pionFSCategories = {   new FSCategory("QE-like", {-211, -321, -311, -111,211, 111, 321, 311}),
						      ...
						      new FSCategory("N Pi Plus Only", {-211,111, 321, 311, -111,-321,-311}, {211}, {2}),
                                                      ...
                                                      new FSCategory("Kaon Plus Only",{-211, 211, -111, 111, -321, 311}, {321}),
						      ...
						      new FSCategory("Pi Plus Minus and Kaons", {9999}, {211, -211,321, -321,311,111}),	      				      
