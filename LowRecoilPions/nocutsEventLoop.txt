#define MC_OUT_FILE_NAME "runEventLoopMC_nocuts.root"
...
int main(const int argc, const char** argv)
{
  ...
  TFile* mc_MichelStudies = TFile::Open("Oct11_hasFittedMichel_reco_102mm.root", "RECREATE");


  signalDefinition.emplace_back(new truth::IsNeutrino<CVUniverse>());
  signalDefinition.emplace_back(new truth::IsCC<CVUniverse>());
  signalDefinition.emplace_back(new Q3Limit<CVUniverse>(0., 1.2));
