#define MC_OUT_FILE_NAME "runEventLoopMC_test.root"
...
int main(const int argc, const char** argv)
{
  ...
  TFile* mc_MichelStudies = TFile::Open("Lowest_Tpi_inEvent_atleast1pion_nodistcut.root", "RECREATE");
  ...
  std::vector<double> dansPTBins = {0, 0.075, 0.15, 0.25, 0.325, 0.4, 0.475, 0.55, 0.7, 0.85, 1, 1.25, 1.5, 2.5, 4.5},
                      ...
                      robsRecoilBins;
  std::vector<double> tpibins = {0, 4., 8., 12., 16., 20., 24., 28., 32., 36., 40., 46., 52., 70., 80., 100., 150., 200., 250., 300., 350., 400., 500., 1000., 2000.};
...
std::function<double(const CVUniverse&, const MichelEvent&, const int)> pion_angle_range1 = [](const CVUniverse& univ, const MichelEvent& evt, const int whichMichel)
                                {
                                  double angle = evt.m_nmichels[whichMichel].best_angle;
                                  double  micheldist = evt.m_nmichels[whichMichel].Best3Ddist;
   				  if (micheldist <= 150.) return angle;
				  else return 9999.;
                                };
...
std::function<double(const CVUniverse&, const MichelEvent&, const int)> pion_angle_range2 = [](const CVUniverse& univ, const MichelEvent& evt, const int whichMichel)
                                {
                                  double angle = evt.m_nmichels[whichMichel].best_angle;
                                  double  micheldist = evt.m_nmichels[whichMichel].Best3Ddist;
                                  if (micheldist >150. && micheldist <= 250.) return angle;
                                  else return 9999.;
                                };
...
std::function<double(const CVUniverse&, const MichelEvent&, const int)> pion_angle_range3 = [](const CVUniverse& univ, const MichelEvent& evt, const int whichMichel)
                                {
                                  double angle = evt.m_nmichels[whichMichel].best_angle;
                                  double  micheldist = evt.m_nmichels[whichMichel].Best3Ddist;
                                  if (micheldist > 250. && micheldist <=500.) return angle;
                                  else return 9999.;
                                };
std::function<double(const CVUniverse&, const MichelEvent&, const int)> pion_angle_range4 = [](const CVUniverse& univ, const MichelEvent& evt, const int whichMichel)
                                {
                                  double angle = evt.m_nmichels[whichMichel].best_angle;
                                  double  micheldist = evt.m_nmichels[whichMichel].Best3Ddist;
                                  if (micheldist > 500.) return angle;
                                  else return 9999.;
                                };
...
std::function<double(const CVUniverse&, const MichelEvent&, const int)> true_angle_range4 = [](const CVUniverse& univ, const MichelEvent& evt, const int whichMichel)
   ...
   studies.push_back(new PerMichelVarByGENIELabel(true_angle, "true_angle", "deg", 20, 0.0, 360., error_bands));
  studies.push_back(new PerMichelVarByGENIELabel(true_angle_range1, "true_angle_range1", "deg", 20, 0.0, 360., error_bands));
  studies.push_back(new PerMichelVarByGENIELabel(true_angle_range2, "true_angle_range2", "deg", 20, 0.0, 360., error_bands));
  studies.push_back(new PerMichelVarByGENIELabel(true_angle_range3, "true_angle_range3", "deg", 20, 0.0, 360., error_bands));
  studies.push_back(new PerMichelVarByGENIELabel(true_angle_range4, "true_angle_range4", "deg", 20, 0.0, 360., error_bands));
   studies.push_back(new PerMichelVarByGENIELabel(pion_angle, "pion_angle", "deg", 20, -180., 180., error_bands));
   studies.push_back(new PerMichelVarByGENIELabel(pion_angle_range1, "pion_angle_range1", "deg", 20, -180., 180., error_bands));
   studies.push_back(new PerMichelVarByGENIELabel(pion_angle_range2, "pion_angle_range2", "deg", 20, -180., 180., error_bands));
   studies.push_back(new PerMichelVarByGENIELabel(pion_angle_range3, "pion_angle_range3", "deg", 20, -180., 180., error_bands));
   studies.push_back(new PerMichelVarByGENIELabel(pion_angle_range4, "pion_angle_range4", "deg", 20, -180., 180., error_bands));

   studies.push_back(new PerMichelVarByGENIELabel(michel_XZ, "best_XZ", "mm", 100, 0.0, 2000., error_bands));
   studies.push_back(new PerMichelVarByGENIELabel(michel_UZ, "best_UZ", "mm", 100, 0.0, 2000., error_bands));
   studies.push_back(new PerMichelVarByGENIELabel(michel_VZ, "best_VZ", "mm", 100, 0.0, 2000., error_bands));
   studies.push_back(new PerMichelVarByGENIELabel(michel_XZ_upvtx, "upvtx_XZ", "mm", 100, 0.0, 2000., error_bands));
   studies.push_back(new PerMichelVarByGENIELabel(michel_XZ_upclus, "upclus_XZ", "mm", 100, 0.0, 2000., error_bands));
   studies.push_back(new PerMichelVarByGENIELabel(michel_XZ_downclus, "downclus_XZ", "mm", 100, 0.0, 2000., error_bands));
   studies.push_back(new PerMichelVarByGENIELabel(michel_XZ_downvtx, "downvtx_XZ", "mm", 100, 0.0, 2000., error_bands));
   studies.push_back(new PerMichelVarByGENIELabel(michel_UZ_upvtx, "upvtx_UZ", "mm", 100, 0.0, 2000., error_bands));
   studies.push_back(new PerMichelVarByGENIELabel(michel_UZ_upclus, "upclus_UZ", "mm", 100, 0.0, 2000., error_bands));
   studies.push_back(new PerMichelVarByGENIELabel(michel_UZ_downclus, "downclus_UZ", "mm", 100, 0.0, 2000., error_bands));
   studies.push_back(new PerMichelVarByGENIELabel(michel_UZ_downvtx, "downvtx_UZ", "mm", 100, 0.0, 2000., error_bands));
   studies.push_back(new PerMichelVarByGENIELabel(michel_VZ_upvtx, "upvtx_VZ", "mm", 100, 0.0, 2000., error_bands));
   studies.push_back(new PerMichelVarByGENIELabel(michel_VZ_upclus, "upclus_VZ", "mm", 100, 0.0, 2000., error_bands));
   studies.push_back(new PerMichelVarByGENIELabel(michel_VZ_downclus, "downclus_VZ", "mm", 100, 0.0, 2000., error_bands));
   studies.push_back(new PerMichelVarByGENIELabel(michel_VZ_downvtx, "downvtx_VZ", "mm", 100, 0.0, 2000., error_bands));

   studies.push_back(new PerMichelVarByGENIELabel(delta_t, "michelmuon_deltat", "#mus", 30, 0.0, 9.0, error_bands));
   studies.push_back(new PerMichelVarByGENIELabel(permichel_range, "permichel_pirange", "mm", 100, 0.0, 2000.0, error_bands));   
   studies.push_back(new PerMichelVarByGENIELabel(overlay_vtx_range, "overlay_vtx_range",  "mm", 100, 0.0, 2000.0, error_bands));    
   studies.push_back(new PerMichelVarByGENIELabel(overlay_clus_range, "overlay_clus_range",  "mm", 100, 0.0, 2000.0, error_bands));
   studies.push_back(new PerMichelVarByGENIELabel(truemichel_goodvtx_range, "truemichel_goodvtx_range",  "mm", 100, 0.0, 2000.0, error_bands));
   studies.push_back(new PerMichelVarByGENIELabel(truemichel_goodclus_range, "truemichel_goodclus_range",  "mm", 100, 0.0, 2000.0, error_bands));
   studies.push_back(new PerMichelVarByGENIELabel(truemichel_badvtx_range, "truemichel_badvtx_range",  "mm", 100, 0.0, 2000.0, error_bands));
   studies.push_back(new PerMichelVarByGENIELabel(truemichel_badclus_range, "truemichel_badclus_range",  "mm", 100, 0.0, 2000.0, error_bands));
   studies.push_back(new PerMichelVarByGENIELabel(permichel_tpi, "Per_Michel_PrimaryParentKE", "meV", 50, 0, 1000., error_bands));
   studies.push_back(new PerMichelVarByGENIELabel(pertruepimichel_range, "permichel_pirange_truepi", "mm", 100, 0.0, 2000.0, error_bands)); 
   
   VarConfig deltat_config{"deltat", "#mus", 30, 0., 9.};
   VarConfig pirange_config{"pirange", "mm", 100, 0.0, 1000.0};
   VarConfig tpi_config{"KE", "meV", 200, 0., 1000.};
...
std::function<double(const CVUniverse&, const MichelEvent&)> lowesttpi = [](const CVUniverse& univ, const MichelEvent& evt)
{
   ...
   studies.push_back(new PerMichelEventVarByGENIELabel(lowesttpi, "LowestKE_pion", "MeV", 50, 0, 1000., error_bands));
...
// Set Up Data Universe
  ...
  data_studies.push_back(new PerMichelVarByGENIELabel(permichel_range, "permichel_pirange", "mm", 100, 0.0, 2000.0, data_error_bands));
 ...
 //   std::cout << "Data cut summary:\n" << mycuts << "\n";
    ...
    TFile* data_MichelStudies = TFile::Open("MichelVars_data.root", "RECREATE");
